 ...
 * user toward the in-app share flow (text or a nicely formatted image) instead.
 */
@Composable
fun ScreenshotReminderDialog(onShareClick: () -> Unit) {
    ...
    if (showDialog) {
        AlertDialog(
            ...
            text = {
                Text(
                    text = "You can share this as text or a neatly formatted image instead of a screenshot.",
