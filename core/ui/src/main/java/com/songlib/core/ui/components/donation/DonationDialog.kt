...
package com.songlib.core.ui.components.donation
    ...
    Dialog(
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = "SongLib requests your donation whether small or big to continue being developed " +
                        " and improved. Our servers also need to be running to serve you and others " +
